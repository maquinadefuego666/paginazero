                                    ...
                                    <div className="col-lg-4 col-md-6 col-12 pe-lg-0">
                                        <a href="javascript:;">
                                            <div className="p-3 pe-md-0">
                                                <img className="w-100 border-radius-md" src="../img/kal-visuals-square.jpg" alt="image" />
                                            </div>
                                        </a>
                                    </div>
                            ...
                            <div className="card card-profile mt-lg-0 mt-5 overflow-hidden">
                                <div className="row">
                                    <div className="col-lg-4 col-md-6 col-12 pe-lg-0">
                                        <a href="javascript:;">
                                            <div className="p-3 pe-md-0">
                                                <img className="w-100 border-radius-md" src="../img/bruce-mars.jpg" alt="image" />
                                            </div>
                                        </a>
                                    </div>
                                    <div className="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
                            ...
                            <div className="card card-profile overflow-hidden z-index-2">
                                <div className="row">
                                    <div className="col-lg-4 col-md-6 col-12 pe-lg-0">
                                        <a href="javascript:;">
                                            <div className="p-3 pe-md-0">
                                                <img className="w-100 border-radius-md" src="../img/team-4.jpg" alt="image" />
                                            </div>
                                        </a>
                                    </div>
                                    <div className="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
                            ...
                            <div className="card card-profile mt-lg-0 mt-5 overflow-hidden z-index-2">
                                <div className="row">
                                    <div className="col-lg-4 col-md-6 col-12 pe-lg-0">
                                        <a href="javascript:;">
                                            <div className="p-3 pe-md-0">
                                                <img className="w-100 border-radius-md" src="../img/ivana-square.jpg" alt="image" />
                                            </div>
                                        </a>
                                    </div>
                                    <div className="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
                ...
                <div className="container">
                    <div className="row mb-7">
                        <div className="col-lg-2 col-md-4 col-6 mb-4">
                            <img className="w-100 opacity-7" src="../img/logos/gray-logos/logo-coinbase.svg" alt="logo" />
                        </div>
                        <div className="col-lg-2 col-md-4 col-6 mb-4">
                            <img className="w-100 opacity-7" src="../img/logos/gray-logos/logo-nasa.svg" alt="logo" />
                        </div>
                        <div className="col-lg-2 col-md-4 col-6 mb-4">
                            <img className="w-100 opacity-7" src="../img/logos/gray-logos/logo-netflix.svg" alt="logo" />
                        </div>
                        <div className="col-lg-2 col-md-4 col-6 mb-4">
                            <img className="w-100 opacity-7" src="../img/logos/gray-logos/logo-pinterest.svg" alt="logo" />
                        </div>
                        <div className="col-lg-2 col-md-4 col-6 mb-4">
                            <img className="w-100 opacity-7" src="../img/logos/gray-logos/logo-spotify.svg" alt="logo" />
                        </div>
                        <div className="col-lg-2 col-md-4 col-6 mb-4">
                            <img className="w-100 opacity-7" src="../img/logos/gray-logos/logo-vodafone.svg" alt="logo" />
                        </div>
                    </div>
                    <div className="row justify-content-center text-center">
                        <div className="col-md-3">
                            <h1 className="text-gradient text-info" id="state1" countto="5234">5,234</h1>
                            <h5>Projects</h5>
                            <p>Of “high-performing” level are led by a certified project manager</p>
                        </div>
                        <div className="col-md-3">
                            <h1 className="text-gradient text-info"><span id="state2" countto="3400">3,400</span>+</h1>
                            <h5>Hours</h5>
