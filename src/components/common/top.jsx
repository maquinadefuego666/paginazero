...
const contact = {
    name : 'Moonred Xion',
    email : 'moonredxion@hotmail.com',
    text : 'I would like to inquiry a system evaluation'
}
                            ...
                            <div className="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" id="navigation">
                                <ul className="navbar-nav navbar-nav-hover ms-lg-12 ps-lg-5 w-100">
                                    <li className="nav-item dropdown dropdown-hover mx-2">
                                        <a className="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" href="javascript:;" id="dropdownMenuPages" data-bs-toggle="dropdown" aria-expanded="false">
                                            Pages
                                        ...
                                        <div className="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                                            <div className="d-none d-lg-block">
                                                ...
                                                <Link to={"/AboutUs"} className="dropdown-item border-radius-md">
                                                ...
                                                <Link to={"/Contact"} state={contact} className="dropdown-item border-radius-md">
                                    ...
                                    <li className="nav-item dropdown dropdown-hover mx-2">
                                        <a className="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" href="javascript:;" id="dropdownMenuBlocks" data-bs-toggle="dropdown" aria-expanded="false">
                                            Blocks
                                            <img src="/img/down-arrow-dark.svg" alt="down-arrow" className="arrow ms-1" />
                                        </a>
                                    ...
                                    <li className="nav-item dropdown dropdown-hover mx-2">
                                        <a className="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" href="javascript:;" id="dropdownMenuDocs" data-bs-toggle="dropdown" aria-expanded="false">
                                            Docs
                                            <img src="/img/down-arrow-dark.svg" alt="down-arrow" className="arrow ms-1" />
                                        </a>
                                    ...
                                    <li className="nav-item ms-lg-auto">
                                        <a className="nav-link nav-link-icon me-2" href="https://github.com/creativetimofficial/soft-ui-design-system" target="_blank">
                                            ...
                                            <p className="d-inline text-sm z-index-1 font-weight-bold" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Star us on Github">Github</p>
                                        </a>
                                    </li>
                                    <li className="nav-item my-auto ms-3 ms-lg-0">
                                        <a href="https://www.creative-tim.com/builder?ref=navbar-soft-design-system" className="btn btn-sm btn-outline-primary btn-round mb-0 me-1 mt-2 mt-md-0">Online Builder</a>
                                    </li>
                                    <li className="nav-item my-auto ms-3 ms-lg-0">
